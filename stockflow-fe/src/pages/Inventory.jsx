...
import { markStockDirtyExternal } from "../utils/systemState";
  ...
  function openEdit(item) {
    ...
    setEditForm({
      ...
      last_restocked_at: item.lastRestockedAt
        ? item.lastRestockedAt.split("T")[0]
        : "",
    });
  }
    ...
    try {
      const { error: invError } = await supabase
        ...
        .update({
          ...
          max_stock:
            editForm.max_stock !== "" ? Number(editForm.max_stock) : null,
        ...
        <div className="filters-grid">
          ...
          <div className="filter-group">
            ...
            >
              <option
                value="all"
                style={{ background: "#1e2026", color: "#f5f7ff" }}
              >
                All stores
              </option>
              {stores.map((s) => (
        ...
        <div className="modal-overlay" onClick={() => setEditItem(null)}>
          ...
          >
            ...
            <p className="modal-subtitle">
              {editItem.product} · {editItem.store}
            </p>
              ...
              <div className="modal-col">
                ...
                <div className="modal-field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setProductForm((f) => ({ ...f, store_id: e.target.value }))
                    }
                ...
                {[
                  ...
                  {
                    label: "Last sale (optional)",
                    key: "last_sale_at",
                    type: "date",
                  },
                  {
                    label: "Last restock (optional)",
                    key: "last_restocked_at",
                    type: "date",
                  },
